<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="tags" name="tags" label="Tags" placeholder="development, coding, java, python" :value="old('tags', $job->tags)" />
            ...
            <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" placeholder="11204" :value="old('zipcode', $job->zipcode)" />
