<x-layout>
    <section class="flex flex-col md:flex-row gap-4 ">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-1/2">
            ...
            @if($user->avatar)
                <div class="mt-2 flex justify-center">
                    <img src="{{asset('storage/' . $user->avatar)}}" alt="{{ $user->name }}" class="w-32 h-32 object-over rounded-full">
                </div>
            @else
                <div class="mt-2 flex justify-center">
                    <img src="{{asset('storage/avatars/default-avatar.png')}}" alt="{{ $user->name }}" class="w-32 h-32 object-over rounded-full">
                </div>
            @endif
            <form
                method="POST"
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            @forelse($jobs as $job)
            <div class="flex justify-between items-center border-b-1 border-gray-200 py-2">
                <div>
            ...
            {{-- Applicants --}}
            <div class="mt-4 bg-gray-100 rounded p-2">
                ...
                <div class="py-2">
                    ...
                    <p class="text-gray-800 mt-2">
                        <a href="{{asset('storage/' . $applicant->resume_path)}}" class="text-blue-500 hover:text-blue-600 hover:underline text-sm" download>
                ...
                @empty
                    <p class="text-gray-700 mb-8">No applicants for this job</p>
                @endforelse
                </div>
            @empty
